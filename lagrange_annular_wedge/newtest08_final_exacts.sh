...
Prec_WLu_NSLSCAMGSim="RAYERROR"
Prec_WLu_NSLSCAMGStr="RAYERROR"
...
PARAM="--dist_prob --prob_id 11  --max_solver_iter 200 --phi_lo 0.0 --phi_hi 90.0 --r_lo 1.0 --r_hi 3.0 --itstimedir $RESITS_DIR --solver_type 2 --bc 0"
