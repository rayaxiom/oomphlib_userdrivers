...
if [ "$VIS" -eq "0" ]; then
  ...
  do
    ...
    do
echo "mpirun -np 1 ./two_d_annular_wedge --dist_prob --prob_id 11  --max_solver_iter 200 --phi_lo 0.0 --phi_hi 90.0 --r_lo 1.0 --r_hi 3.0 --itstimedir res_iterations --solver_type 0 --bc 0 --w_solver 0 --ns_solver 0 --rey 200 --visc 0 --noel $NOEL" >> $TEST_LIST
    done # NOEL
  done # REY
done # VIS
done # PREC
