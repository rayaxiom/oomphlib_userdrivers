...
PARAM="--dist_prob --prob_id 11  --max_solver_iter 200 --phi_lo 0.0 --phi_hi 90.0 --r_lo 1.0 --r_hi 3.0 --itstimedir $RESITS_DIR --solver_type 2 --print_hypre --w_solver 0 --ns_solver 1 --f_solver 96 --f_amg_iter 1 --f_amg_smiter 2 --f_amg_coarse 1 --f_amg_sim_smoo 1 --bc 0"
...
# As per FIS p364
REYLIST="100 200"
STRNLIST="0.25 0.35 0.5 0.6666 0.7 0.75 0.8"
