...
PROGRAM="unstructured_lgr_pressureimposed"
...
DOCNUM="--doc_num 1"
DT="--dt 0.5"
PARAM2="${PARAM} ${TETGENNUM} ${DOCNUM} ${DT}"
...
then
  ...
  cd ${SCRATCH_TEST_DIR} 
  mkdir RESLT
  ln -s /mnt/iusers01/mh01/mbax5ml3/trunk_optimized/user_drivers/unstructured_three_d_fluid/tetgen_notaligned tetgen_notaligned
