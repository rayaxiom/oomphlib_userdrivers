...
FPARAM="--f_solver 1 --f_amg_iter 2 --f_amg_smiter 2 --f_amg_sim_smoo 1 --f_amg_damp -1.0 --print_f_hypre --f_amg_coarse 1 --amg_level 3"
...
# As per FIS p364
REYLIST="100"
STRNLIST="0.20 0.25 0.35 0.5 0.668 0.7 0.75 0.80 0.90"
NOELLIST="20"
...
echo "mpirun -np 1 ./$PROGRAM $PROBPARAM --visc $VIS --viscous $VIS --rey $REY $LPARAMLSC $PPARAM $FPARAM --f_amg_str $STRN --noel $NOEL" >> $TEST_LIST
      done
    done
  done
done
