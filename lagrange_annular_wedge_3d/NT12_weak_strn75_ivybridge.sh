...
FPREC="--f_solver 1 --f_amg_iter 1 --f_amg_smiter 2 --f_amg_sim_smoo 4 --f_amg_damp 1 --f_amg_str 0.75 --print_f_hypre"
...
case "$NPROC" in
  1)
    ...
    ;;
  2)
    MPIRUN="mpirun -np 2 taskset -c 0,8"
    NOEL="18"
    ;;
  4)
    MPIRUN="mpirun -np 4 taskset -c 0-1,8-9"
    NOEL="22"
    ;;
  8)
    MPIRUN="mpirun -np 8 taskset -c 0-3,8-11"
    NOEL="28"
    ;;
  16)
    MPIRUN="mpirun -np 16 taskset -c 0-7,8-15"
    NOEL="35"
    ;;
#  24)
