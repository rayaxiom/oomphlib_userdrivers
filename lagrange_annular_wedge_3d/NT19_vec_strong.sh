...
PROBPARAM="--time_type 1 --solver_type 2 --dist_prob --max_solver_iter 100 --dt 0.01 --time_start 0.0 --time_end 0.5  --itstimedir $RESITS_DIR --visc 0 --rey 200 --prob_id 0 --vectest"
# --noel taken out
