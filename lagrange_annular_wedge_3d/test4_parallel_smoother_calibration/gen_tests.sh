...
## Loop through:
# Smoother: 0 (Jac), 3 (SOR fs), 4 (SOR bs), 6(SSOR)
# Damping: 0.25, 0.5, 0.75. 1,
# Visc: 0 (Sim), 1(Str)
# Re: 200,
# Noel 4 6 8 10 12 14 16 18 20


SMOOTHERLIST="0 3 4 6"
DAMPLIST="0.25 0.5 0.75 1"
VISCLIST="0 1"
REYLIST="200"
NOELLIST="4 6 8 10 12 14 16 18"

for SMOOTHER in $SMOOTHERLIST
do
...
PSOLVER="$PSOLVER_EXACT"
FSOLVER="$FSOLVER_AMG"
F_ITER="--f_amg_iter 1"
F_SMITER="--f_amg_smiter 2"
F_COARSE="--f_amg_coarse 0"
F_STR="--f_amg_str 0.75"
F_SMOOTHER="--f_amg_sim_smoo $SMOOTHER"
F_DAMP="--f_amg_damp $DAMP"
F_PRINT="--print_f_hypre"

F_PREC="$F_ITER $F_SMITER "
F_PREC+="$F_SMOOTHER $F_DAMP $F_COARSE $F_STR "
F_PREC+="$F_PRINT"

PRECPARAM="$WSOLVER $NSSOLVER $PSOLVER $FSOLVER $F_PREC"


NSHELPER="--visc $VISC --rey 200"
...
Files_to_copy+=("Aw3D_smoother.qsub")

#############################################################################
ABS_SCRATCH_DIR="/mnt/iusers01/mh01/mbax5ml3/scratch/mpi_optimized/user_drivers/lagrange_annular_wedge_3d/test4_parallel_smoother_calibration/"
