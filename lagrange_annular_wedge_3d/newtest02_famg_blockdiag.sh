...
FPARAM="--f_solver 1 --f_amg_iter 2 --f_amg_smiter 2 --f_amg_sim_smoo 4 --f_amg_damp 1.0 --print_f_hypre --f_amg_coarse 0 --f_amg_str 0.75"
...
echo "mpirun -np 1 ./$PROGRAM $PROBPARAM --visc $VIS --viscous $VIS --rey $REY $LPARAMLSC $PPARAM --f_solver $FSOLVER --noel $NOEL" >> $TEST_LIST
      done
    done
  done
done
