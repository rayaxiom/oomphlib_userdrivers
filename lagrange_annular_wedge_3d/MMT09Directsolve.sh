...
Prec_WLu_NSLSCAMGSim="$LPARAMLSC $PPARAM --f_solver 1 --f_amg_iter 1 --f_amg_smiter 2 --f_amg_coarse 1 --f_amg_sim_smoo 1 --f_amg_damp -1 --f_amg_str 0.668 --print_f_hypre"
...
echo "mpirun -np 1 ./annular_wedge_threed --time_type 1 --solver_type 0 --dist_prob --max_solver_iter 300 --dt 0.01 --time_start 0.0 --time_end 0.5 --itstimedir res_iterations --prob_id 0 --visc 0 --rey 500 --w_solver 0 --ns_solver 0 --noel $NOEL" >> $TEST_LIST
