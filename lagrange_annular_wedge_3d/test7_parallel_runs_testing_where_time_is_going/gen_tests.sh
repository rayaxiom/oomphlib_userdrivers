...
P_ITER="--p_amg_iter 1"
P_SMITER="--p_amg_smiter 2"
P_SIM_SMOO="--p_amg_sim_smoo 4" # Jacobi = 0, SOR bs = 4
P_DAMP="--p_amg_damp 1"
...
############################################################################
ABS_SCRATCH_DIR="/mnt/iusers01/mh01/mbax5ml3/scratch/mpi_optimized/user_drivers/lagrange_annular_wedge_3d/test7_parallel_runs_testing_where_time_is_going/"
