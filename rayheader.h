...
//
//    // the viscuous term is handled by NavierStokesProblemParameters above.
//    // Here, we drag the value out and store it in the creation of the
//    // preconditioner.
...
//    {
//      param_pt->Use_axnorm = false;
//    }
//    else
//    {
//      param_pt->Use_axnorm = true;
//    }
//
//    if(CommandLineArgs::command_line_flag_has_been_set("--bdw"))
//    {
//      param_pt->Use_block_diagonal_w = true;
//    }
//    else
//    {
//      param_pt->Use_block_diagonal_w = false;
//    }
//  } // LPH::generic_setup()
//
//  inline Preconditioner* setup_preconditioner(const PrecParam* param_pt)
//  {
...
//   // actually set.
//   namespace NSPP = NavierStokesProblemParameters::Doc_linear_solver_info_pt;
//   if(NSPP::Doc_linear_solver_info_pt == 0)
//   {
//      std::ostringstream err_msg;
//      err_msg << "Please set NSPP::Doc_linear_solver_info_pt\n"
//        << std::endl;
//      throw OomphLibError(err_msg.str(),
//          OOMPH_CURRENT_FUNCTION,
//          OOMPH_EXCEPTION_LOCATION);
//   }
//
//   prec_pt->set_doc_linear_solver_info_pt(NSPP::Doc_linear_solver_info_pt);
//
//// if(param_pt->Use_block_diagonal_w)
//// {
...
//// prec_pt->set_doc_prec_directory_pt(&param_pt->Doc_prec_dir_str);
//    return prec_pt;
...
//  LagrangianPreconditionerHelpers::PrecParam* Prec_param_pt = 0;
