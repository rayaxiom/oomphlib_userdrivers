...
Files_to_copy+=("poisson3d_np1.list")
Files_to_copy+=("poisson3d_np2.list")
Files_to_copy+=("poisson3d_np4.list")
Files_to_copy+=("poisson3d_np8.list")
# Now add the qsub files to the files to copy.
Files_to_copy+=("poisson3d_np1.qsub")
Files_to_copy+=("poisson3d_np2.qsub")
Files_to_copy+=("poisson3d_np4.qsub")
Files_to_copy+=("poisson3d_np8.qsub")


############################################################################
ABS_SCRATCH_DIR="/mnt/iusers01/mh01/mbax5ml3/scratch/mpi_optimized/user_drivers/milan_permutation/test0_dump_matrices/"
...
MAT_OUTPUT_DIR="raw_lin_system"
mkdir -p $ABS_SCRATCH_DIR$MAT_OUTPUT_DIR
