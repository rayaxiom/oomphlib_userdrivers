...
############################################################################
ABS_SCRATCH_DIR="/mnt/iusers01/mh01/mbax5ml3/scratch/mpi_optimized/user_drivers/milan_permutation/test2_without_permute/"
...
###
## Important 2: Create the raw_lin_system directory
RAWMAT="raw_lin_system"
ABS_SCRATCH_RAWMAT="/mnt/iusers01/mh01/mbax5ml3/scratch/mpi_optimized/user_drivers/milan_permutation/$RAWMAT"
ln -s $ABS_SCRATCH_RAWMAT $RAWMAT
