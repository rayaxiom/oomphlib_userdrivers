...
AMG_PARAM="$AMG_ITER $AMG_SMITER "
AMG_PARAM="$AMG_PARAM $AMG_SIM_SMOO $AMG_DAMP "
AMG_PARAM="$AMG_PARAM $AMG_STRN $AMG_COARSE"
...
FULLPARAM="${AMG_PARAM} ${TETGEN_FILE} --dump_mat_only"
