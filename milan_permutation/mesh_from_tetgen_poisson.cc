...
//  }
 ...
 string tetgen_area(argv[1]);

 string tetgen_directory = "tetgen_files_cube_hole";


 string node_file_name = tetgen_directory 
                        + "/" 
                        + tetgen_area 
                        + "/" 
                        + "cube_hole.1.node";

 string element_file_name = tetgen_directory 
                          + "/" 
                          + tetgen_area 
                          + "/" 
                          + "cube_hole.1.ele";

 string face_file_name = tetgen_directory 
                       + "/" 
                       + tetgen_area 
                       + "/" 
                       + "cube_hole.1.face";
