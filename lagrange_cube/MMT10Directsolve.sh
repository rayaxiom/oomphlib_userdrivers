...
if [ "$VIS" -eq "0" ]; then
  ...
  do
    ...
    do
echo "mpirun -np 1 ./lgr_cube --time_type 1 --dist_prob --time_start 0.0 --time_end 1.0 --prob_id 0  --max_solver_iter 100 --itstimedir res_iterations --solver_type 0 --w_solver 0 --ns_solver 1 --w_solver 0 --ns_solver 0 --ang 67 --rey 500 --visc 0 --noel $NOEL" >> $TEST_LIST
    done # NOEL
  done # REY
  done #ANG
done # VIS
