...
RES_DIR="test2_2v2Strn0-75cRSEuclid_oomph"
mkdir -p $RES_DIR
PROGRAM="lgr_cube"

#################
TIMETYPE="--time_type 1" # Adaptive
SOLVERTYPE="--solver_type 1" # OOMPH-LIB's GMRES
DISTPROB="--dist_prob"
...
F_SMOOTHER="--f_amg_com_smoo 9" ## CHANGE THIS
F_DAMP="--f_amg_damp -1"
...
VISC="--visc 0"
mpirun -np 1 ./$PROGRAM $PARAM $VISC --noel 4
mpirun -np 1 ./$PROGRAM $PARAM $VISC --noel 6
mpirun -np 1 ./$PROGRAM $PARAM $VISC --noel 8
mpirun -np 1 ./$PROGRAM $PARAM $VISC --noel 10
mpirun -np 1 ./$PROGRAM $PARAM $VISC --noel 12
mpirun -np 1 ./$PROGRAM $PARAM $VISC --noel 14
mpirun -np 1 ./$PROGRAM $PARAM $VISC --noel 16
mpirun -np 1 ./$PROGRAM $PARAM $VISC --noel 18
