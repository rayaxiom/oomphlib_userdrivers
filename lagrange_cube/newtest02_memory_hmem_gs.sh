...
PPARAM="--p_solver 1 --p_amg_iter 1 --p_amg_smiter 2 --p_amg_sim_smoo 0 --p_amg_damp 0.668  --p_amg_str 0.7 --p_amg_coarse 1 --print_p_hypre"
FPARAM="--f_solver 1 --f_amg_iter 2 --f_amg_smiter 2 --f_amg_sim_smoo 1 --f_amg_damp -1 --f_amg_coarse 1 --f_amg_str 0.25 --print_f_hypre"
PARAM="--time_type 1 --solver_type 2 --dist_prob --time_start 0.0 --time_end 1.0 --prob_id 0  --max_solver_iter 300 --itstimedir $RESITS_DIR --solver_type 2 --w_solver 0 --ns_solver 1 --ang 67"
...
NOELLIST="18 20 22 24 26 28 30 32 34 36 38"
...
#    do
      ...
      do
echo "mpirun -np 1 ./$PROGRAM $PARAM --rey $REY --visc $VIS $PPARAM $FPARAM --noel $NOEL" >> $TEST_LIST
      done
#    done
  done
done
