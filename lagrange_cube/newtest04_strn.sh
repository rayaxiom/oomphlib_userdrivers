...
FPARAM="--f_solver 1 --f_amg_iter 2 --f_amg_smiter 2 --f_amg_sim_smoo 1 --f_amg_damp -1 --f_amg_coarse 1 --print_f_hypre"
...
# As per FIS p364
REYLIST="100 200"
STRNLIST="0.20 0.25 0.35 0.5 0.668 0.7 0.75 0.80"
...
do
  ...
  do
    ...
    do
      ...
      do
echo "mpirun -np 1 ./$PROGRAM $PARAM --rey $REY --visc $VIS $PPARAM $FPARAM --f_amg_str $STRN --noel $NOEL" >> $TEST_LIST
      done
    done
  done
done
