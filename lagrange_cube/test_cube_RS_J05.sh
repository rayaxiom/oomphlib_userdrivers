...
case "$PREC" in
  ...
  4)
    if [ "$VIS" -eq "0" ]; then
      PREC_PARAM="--w_solver 0 --ns_solver 1 --p_solver 1 --f_solver 96 --f_amg_iter 1 --f_amg_smiter 2 --f_amg_sim_smoo 0 --f_amg_damp 0.5 --f_amg_str 0.25 --f_amg_coarse 1"
    else
      PREC_PARAM="--w_solver 0 --ns_solver 1 --p_solver 1 --f_solver 96 --f_amg_iter 1 --f_amg_smiter 2 --f_amg_sim_smoo 0 --f_amg_damp 0.5 --f_amg_str 0.668 --f_amg_coarse 1"
    fi
    ;;
esac
...
TESTLIST_FILEBASE="tests_cube_RS_J05"
