...
FPARAMSIM="--f_solver 1 --f_amg_iter 2 --f_amg_smiter 2 --f_amg_sim_smoo 0 --f_amg_coarse 1 --f_amg_str 0.25 --print_f_hypre"
FPARAMSTR="--f_solver 1 --f_amg_iter 2 --f_amg_smiter 2 --f_amg_sim_smoo 0 --f_amg_coarse 1 --f_amg_str 0.75 --print_f_hypre"
...
if [ "$VIS" -eq "0" ]; then
  ...
  do
    ...
    do
      ...
      do
echo "mpirun -np 1 ./$PROGRAM $PARAM --rey $REY --visc $VIS $PPARAM $PRECPARAM --f_amg_damp $DAMP --noel $NOEL" >> $TEST_LIST
      done
    done
  done
done
