...
COMMON_PARAM="--dist_prob --prob_id 21 --max_solver_iter 100 --solver_type 2 --dt 0.1"
...
TESTLIST_FILEBASE="tests_cube"
TEST_LIST="$TESTLIST_FILEBASE.list"

gen_tests_cube_exact
gen_tests_cube_amg
...
ANGLIST="Ax0y0z0 Ax30y30z30"
NOELLIST="N4 N6 N8 N10 N12 N14 N16"
