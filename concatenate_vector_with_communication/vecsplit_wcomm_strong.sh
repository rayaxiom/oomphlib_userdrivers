...
echo "mpirun -np 8 taskset -c 0-3,12-15 ./$PROGRAM --nblock1d $NBLOCK1D --nn $NN" >> $TEST_LIST
echo "mpirun -np 16 taskset -c 0-7,12-19 ./$PROGRAM --nblock1d $NBLOCK1D --nn $NN" >> $TEST_LIST
