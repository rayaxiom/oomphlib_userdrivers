...
{
NBLOCK1D="16"
echo "mpirun -np 1 taskset -c 0 ./$PROGRAM --nblock1d $NBLOCK1D --nn 25000000" >> $TEST_LIST
echo "mpirun -np 2 taskset -c 0,12 ./$PROGRAM  --nblock1d $NBLOCK1D --nn 50000000" >> $TEST_LIST
echo "mpirun -np 4 taskset -c 0-1,12-13 ./$PROGRAM --nblock1d $NBLOCK1D --nn 100000000" >> $TEST_LIST
echo "mpirun -np 8 taskset -c 0-3,12-15 ./$PROGRAM --nblock1d $NBLOCK1D --nn 200000000" >> $TEST_LIST
echo "mpirun -np 16 taskset -c 0-7,12-19 ./$PROGRAM --nblock1d $NBLOCK1D --nn 400000000" >> $TEST_LIST
