...
#NN="125000000"
NN="100000000"
echo "mpirun -np 1 taskset -c 0 ./$PROGRAM --nblock1d $NBLOCK1D --nn 5369072" >> $TEST_LIST
echo "mpirun -np 2 taskset -c 0,12 ./$PROGRAM  --nblock1d $NBLOCK1D --nn 10698620" >> $TEST_LIST
echo "mpirun -np 4 taskset -c 0-1,12-13 ./$PROGRAM --nblock1d $NBLOCK1D --nn 20942950" >> $TEST_LIST
echo "mpirun -np 8 taskset -c 0-3,12-15 ./$PROGRAM --nblock1d $NBLOCK1D --nn 41427328" >> $TEST_LIST
echo "mpirun -np 16 taskset -c 0-7,12-19 ./$PROGRAM --nblock1d $NBLOCK1D --nn 83164400" >> $TEST_LIST
