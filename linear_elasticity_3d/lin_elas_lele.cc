...
//                        *cos(2.0*MathematicalConstants::Pi*x[1]/Ly);
//
  ...
  result[1] = -Amplitude*sin(2.0*MathematicalConstants::Pi*x[0]/Lx)
                        *sin(2.0*MathematicalConstants::Pi*x[2]/Lz);
 }
} // end_of_namespace
...
//     /  |          /  |     Front = 5 free
//    /   |         /   |     Back = 0 free
//    --------------    |     Bottom = 1 (pinned to 0)
//    |   |--------|----|     Top =  3 (periodic traction)
//    |   /        |   /
//    |  /         |  /
//    | /          | /
//    |/           |/
...
// doc_info.set_directory("RESLT");
 ...
 // Set up problem
 PeriodicLoadProblem<MyLinearElasticityElement<3,2> > problem;
