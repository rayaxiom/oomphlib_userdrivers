...
NDOF="200000"
NPROC="1"
TESTLIST="linq_ndof${NDOF}_np${NPROC}.qsub"
Files_to_copy+=($TESTLIST)
...
ABS_SCRATCH_DIR="/mnt/iusers01/mh01/mbax5ml3/scratch/mpi_optimized/user_drivers/linear_elasticity_3d/test2_linear_elements/"
