...
#FPARAM="--f_solver 1 --f_amg_iter 2 --f_amg_smiter 2 --f_amg_sim_smoo 1 --f_amg_damp -1.0 --print_f_hypre --f_amg_coarse 1"
# I took out --f_amg_str from the above since we set it below.
...
# THINGS TAKEN OUT FROM THE ABOVE:
# --visc 0
# --rey 0
# --noel 6
...
# As per FIS p364
#REYLIST="100 200"
STRNLIST="0.20 0.25 0.35 0.5 0.668 0.7 0.75 0.80 0.90 0.95 1"
...
echo "mpirun -np 1 ./$PROGRAM --noel 40 --amg_iter 1 --amg_smiter 1 --amg_sim_smoo 1 --amg_coarse 1 --amg_print_level 1 --amg_strn $STRN" >> $TEST_LIST
#      done
    done
#  done
#done
