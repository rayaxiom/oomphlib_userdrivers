...
{
NBLOCK1D="16"
echo "mpirun -np 1 taskset -c 0 ./mat_cat --nblock1d $NBLOCK1D --nn 712" >> $TEST_LIST
echo "mpirun -np 2 taskset -c 0,12 ./mat_cat  --nblock1d $NBLOCK1D --nn 1007" >> $TEST_LIST
echo "mpirun -np 4 taskset -c 0-1,12-13 ./mat_cat --nblock1d $NBLOCK1D --nn 1425" >> $TEST_LIST
echo "mpirun -np 8 taskset -c 0-3,12-15 ./mat_cat --nblock1d $NBLOCK1D --nn 2015" >> $TEST_LIST
echo "mpirun -np 16 taskset -c 0-7,12-19 ./mat_cat --nblock1d $NBLOCK1D --nn 2850" >> $TEST_LIST
echo "mpirun -np 24 taskset -c 0-23 ./mat_cat --nblock1d $NBLOCK1D --nn 3491" >> $TEST_LIST
}
