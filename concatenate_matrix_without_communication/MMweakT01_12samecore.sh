...
{
NBLOCK1D="16"
echo "mpirun -np 12 taskset -c 0-11 ./mat_cat --nblock1d $NBLOCK1D --nn 2468" >> $TEST_LIST
echo "mpirun -np 12 taskset -c 0-5,12-17 ./mat_cat  --nblock1d $NBLOCK1D --nn 2468" >> $TEST_LIST
}
