...
{
NBLOCK1D="16"
echo "mpirun -np 1 ./mat_cat --nblock1d $NBLOCK1D --nn 712" >> $TEST_LIST
echo "mpirun -np 2 ./mat_cat  --nblock1d $NBLOCK1D --nn 1007" >> $TEST_LIST
echo "mpirun -np 4 ./mat_cat --nblock1d $NBLOCK1D --nn 1425" >> $TEST_LIST
echo "mpirun -np 8 ./mat_cat --nblock1d $NBLOCK1D --nn 2015" >> $TEST_LIST
echo "mpirun -np 16 ./mat_cat --nblock1d $NBLOCK1D --nn 2850" >> $TEST_LIST
}
