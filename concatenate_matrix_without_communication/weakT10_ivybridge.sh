...
echo "mpirun -np 2 taskset -c 0,8 ./mat_cat  --nblock1d $NBLOCK1D --nn 1007" >> $TEST_LIST
echo "mpirun -np 4 taskset -c 0-1,8-9 ./mat_cat --nblock1d $NBLOCK1D --nn 1425" >> $TEST_LIST
echo "mpirun -np 8 taskset -c 0-3,8-11 ./mat_cat --nblock1d $NBLOCK1D --nn 2015" >> $TEST_LIST
echo "mpirun -np 16 taskset -c 0-7,8-15 ./mat_cat --nblock1d $NBLOCK1D --nn 2850" >> $TEST_LIST
}
