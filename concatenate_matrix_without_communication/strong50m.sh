...
function gen_tests()
{
echo "mpirun -np 1 ./mat_cat --nn 10000" >> $TEST_LIST
echo "mpirun -np 2 ./mat_cat --nn 10000" >> $TEST_LIST
echo "mpirun -np 4 ./mat_cat --nn 10000" >> $TEST_LIST
echo "mpirun -np 8 ./mat_cat --nn 10000" >> $TEST_LIST
echo "mpirun -np 16 ./mat_cat --nn 10000" >> $TEST_LIST
echo "mpirun -np 24 ./mat_cat --nn 10000" >> $TEST_LIST
}
