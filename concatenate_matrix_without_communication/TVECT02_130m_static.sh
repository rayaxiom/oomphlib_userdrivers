...
{
NBLOCK1D="16"
echo "mpirun -np 1 taskset -c 0 ./$PROGRAM" >> $TEST_LIST
echo "mpirun -np 2 taskset -c 0,12 ./$PROGRAM" >> $TEST_LIST
echo "mpirun -np 4 taskset -c 0-1,12-13 ./$PROGRAM" >> $TEST_LIST
echo "mpirun -np 8 taskset -c 0-3,12-15 ./$PROGRAM" >> $TEST_LIST
echo "mpirun -np 16 taskset -c 0-7,12-19 ./$PROGRAM" >> $TEST_LIST
echo "mpirun -np 24 taskset -c 0-23 ./$PROGRAM" >> $TEST_LIST
}
