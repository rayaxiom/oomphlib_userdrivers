...
echo "mpirun -np 1 taskset -c 0 ${CGINPUT} ./${PROGRAM} --nblock1d ${NBLOCK1D} --nn ${NN}" >> ${TEST_LIST}
echo "mpirun -np 2 taskset -c 0,12 ${CGINPUT} ./${PROGRAM}  --nblock1d ${NBLOCK1D} --nn ${NN}" >> ${TEST_LIST}
echo "mpirun -np 4 taskset -c 0-1,12-13 ${CGINPUT} ./${PROGRAM} --nblock1d ${NBLOCK1D} --nn ${NN}" >> ${TEST_LIST}
echo "mpirun -np 8 taskset -c 0-3,12-15 ${CGINPUT} ./${PROGRAM} --nblock1d ${NBLOCK1D} --nn ${NN}" >> ${TEST_LIST}
echo "mpirun -np 16 taskset -c 0-7,12-19 ${CGINPUT} ./${PROGRAM} --nblock1d ${NBLOCK1D} --nn ${NN}" >> ${TEST_LIST}
echo "mpirun -np 24 taskset -c 0-23 ${CGINPUT} ./${PROGRAM} --nblock1d ${NBLOCK1D} --nn ${NN}" >> ${TEST_LIST}
}
