...
function gen_tests()
{
echo "mpirun -np 1 ./mat_cat --nn 1767" >> $TEST_LIST
echo "mpirun -np 2 ./mat_cat --nn 2500" >> $TEST_LIST
echo "mpirun -np 4 ./mat_cat --nn 3535" >> $TEST_LIST
echo "mpirun -np 8 ./mat_cat --nn 5000" >> $TEST_LIST
echo "mpirun -np 16 ./mat_cat --nn 7071" >> $TEST_LIST
