...
PARAM="--dist_prob --prob_id 11  --max_solver_iter 300 --itstimedir $RESITS_DIR --solver_type 1 --print_hypre --w_solver 0 --ns_solver 1 --p_solver 0 --ang 30"
...
FSOLVERLIST="9190 9191 9192 9193"
