...
FPARAMSIM="--f_solver 96 --f_amg_iter 1 --f_amg_smiter 2 --f_amg_coarse 1 --f_amg_sim_smoo 1 --f_amg_damp -1 --f_amg_str 0.25"
FPARAMSTR="--f_solver 96 --f_amg_iter 1 --f_amg_smiter 2 --f_amg_coarse 1 --f_amg_sim_smoo 1 --f_amg_damp -1 --f_amg_str 0.668"
...
# LU ALSC SIM
# LU ALSC STR
#Prec_WLu_NSLu="--ns_solver 0"
Prec_NSLSCExact="--lsc_only --ns_solver 1 --p_solver 0 --f_solver 0"
Prec_NSLSCAMGSim="--lsc_only --ns_solver 1 --print_hypre $PPARAM $FPARAMSIM"
Prec_NSLSCAMGStr="--lsc_only --ns_solver 1 --print_hypre $PPARAM $FPARAMSTR"

PARAM="--dist_prob --prob_id 88  --max_solver_iter 100 --itstimedir $RESITS_DIR --solver_type 2"
# Need to set below:
# rey
# visc
# noel
...
PRECPARAM=""
PRECLIST="2" #NEEDS TO BE 2 for standard LSC AMG
...
if [ "$VIS" -eq "0" ]; then
  case "$PREC" in
    1)
      PRECPARAM="$Prec_NSLSCExact"
      ;;
    2)
      PRECPARAM="$Prec_NSLSCAMGSim"
      ;;
  esac
else
  case "$PREC" in
