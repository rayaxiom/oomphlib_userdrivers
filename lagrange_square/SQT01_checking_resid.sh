...
function gen_tests()
{
echo "mpirun -np 1 ./sq_lgr --dist_prob --prob_id 11  --max_solver_iter 110 --itstimedir res_iterations --solver_type 1 --print_hypre --w_solver 0 --ns_solver 0 --rey 0 --visc 0 --ang 0 --noel 128" >> $TEST_LIST
} # End of gen_tests
