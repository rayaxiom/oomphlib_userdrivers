...
Prec_WLu_NSLSCAMGSim="--w_solver 0 --ns_solver 1 --p_solver 1 --f_solver 96 --f_amg_iter 2 --f_amg_smiter 2 --f_amg_coarse 1 --f_amg_sim_smoo 1 --f_amg_damp -1 --f_amg_str 0.25"
Prec_WLu_NSLSCAMGStr="--w_solver 0 --ns_solver 1 --p_solver 1 --f_solver 96 --f_amg_iter 2 --f_amg_smiter 2 --f_amg_coarse 1 --f_amg_sim_smoo 1 --f_amg_damp -1 --f_amg_str 0.668"
...
PARAM="--dist_prob --prob_id 11  --max_solver_iter 110 --itstimedir $RESITS_DIR --solver_type 2 --print_hypre"
