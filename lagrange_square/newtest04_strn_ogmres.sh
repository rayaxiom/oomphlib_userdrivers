...
PARAM="--dist_prob --prob_id 11  --max_solver_iter 300 --itstimedir $RESITS_DIR --solver_type 1 --print_hypre --w_solver 0 --ns_solver 1 --p_solver 0 --f_solver 96 --f_amg_iter 1 --f_amg_smiter 2 --f_amg_coarse 1 --f_amg_sim_smoo 1 --ang 30"
...
# As per FIS p364
REYLIST="100 200"
STRNLIST="0.25 0.35 0.5 0.666 0.7 0.75 0.8"
