...
VISLIST="0 1"
ANGLIST="0 30 67"
RELIST="0" # TO BE SET LATER
RE_PARAM="--rey_start 0 --rey_end 200 --rey_incre 25"
...
echo "mpirun -np 1 ./$PROGRAM $COMMON_PARAM $PREC_PARAM --visc $VIS --ang $ANG $RE_PARAM --noel $NOEL --itstimedir $RESITS_DIR" >> $TEST_LIST
        done
      done
    done
  done
